...
function verifyQuestions() {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield pool.query('SELECT COUNT(*) AS count FROM questions');
...
function seedRooms() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield pool.query('DELETE FROM rooms');
...
function seedGames() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield pool.query('DELETE FROM game_questions');
        yield pool.query('DELETE FROM games');
    ...
    `;
        ...
        const gameResult = yield pool.query(gameQuery, gameValues);
        const gameId = gameResult.rows[0].game_id;
        // Update references to `id` with the new identifiers like `question_id` and `game_id`
        const questionIdsResult = yield pool.query('SELECT question_id FROM questions LIMIT 15');
        ...
        for (const questionId of questionIds) {
            ...
            VALUES ($1, $2)
        `;
            yield pool.query(gameQuestionQuery, [gameId, questionId]);
        }
...
function seedDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            client.release();
            yield seedQuestions();
            yield verifyQuestions();
            yield seedRooms();
            yield seedGames(); // Add the new seedGames function here
